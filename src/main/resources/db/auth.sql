...
/* client_credentials模式，前端客户端使用password模式, client秘钥明文:888888*/
INSERT INTO `oauth_client_details` VALUES ('my_client_id','gate_way_server','$2a$10$p8Bv0IXu1jTcpTKQv3O.2OPLxh4FhfqGqenw9mtRdKo7dA275HKbi','user_info','authorization_code,refresh_token,implicit,password,client_credentials','http://www.baidu.com','ROLE_ADMIN',7200,86400,'{\"systemInfo\":\"Atlas System\"}','true');
...
--
-- 微信小程序列表：一个手机号支持多个小程序或公众号
--
CREATE TABLE IF NOT EXISTS t_wxapp (                                          
  	id int NOT NULL AUTO_INCREMENT,						/*     表标识			     	           	*/
  	username varchar(32) DEFAULT '',					/*     用户名			     	           	*/
	openId varchar(32) default NULL,					/*     微信APPID		     	           	*/                   
  	type tinyint DEFAULT 1,				   				/*     1:小程序 2公众号						*/
  	reserver1 varchar(64) default NULL,					/*     保留字段		    				*/
	reserver2 varchar(64) default NULL,					/*     保留字段		    				*/
	primary key(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='wechat openid list';
